define('app',['exports', './middleware/pre-login-url', './middleware/authorize-step', './common/app-config', './routes'], function (exports, _preLoginUrl, _authorizeStep, _appConfig, _routes) {
  'use strict';
  ...
  var _preLoginUrl2 = _interopRequireDefault(_preLoginUrl);
  ...
  var App = exports.App = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.addPipelineStep('authorize', _preLoginUrl2.default);
...
define('middleware/pre-login-url',['exports'], function (exports) {
  ...
  var PreLoginUrl = function () {
    ...
    PreLoginUrl.prototype.run = function run(routingContext, next) {
      var skipRoutes = ['login', 'register', 'about'];
  ...
  var ApiService = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _authService2.default, _appConfig2.default), _dec(_class = function () {
    function ApiService(http, authService, appConfig) {
      ...
      this.http.configure(function (config) {
        config.useStandardConfiguration().withBaseUrl(appConfig.apiUrl).withDefaults({
          headers: {
          ...
          request: function request(_request) {
            return authService.authorizeRequest(_request);
          }
        });
      });
    }
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return this.http.fetch(path, {
                  ...
                  return responseObject = error.json();
                });

              case 3:
                return _context2.abrupt('return', responseObject);
...
define('features/account/login',['exports', 'aurelia-framework', 'aurelia-router', '../../services/api-service', '../../services/auth-service', '../../common/app-config'], function (exports, _aureliaFramework, _aureliaRouter, _apiService, _authService, _appConfig) {
  'use strict';
...
define('features/home/about',["exports"], function (exports) {
  "use strict";
